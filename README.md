...
This repo is set up for **HariniAnkireddypalli/portfolio**. To deploy:
...
3. **Turn on GitHub Pages** in the repo:
   - GitHub → **portfolio** → **Settings** → **Pages**
   - Under **Build and deployment**, set **Source** to **Deploy from a branch**
   - **Branch**: `gh-pages` → `/ (root)` → **Save**

Your site will be at **https://HariniAnkireddypalli.github.io/portfolio** (may take 1–2 minutes after the first deploy).
...
- **Repo name**: Change `base` in `vite.config.js` and `homepage` in `package.json` to match your GitHub repo (HariniAnkireddypalli/portfolio).
